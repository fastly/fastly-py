...
class WafTagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_waf_tags_endpoint = _Endpoint(
            settings={
                'response_type': (WafTagsResponse,),
                'auth': [
                    'token'
                ],
    ...
    def list_waf_tags(
        ...
        **kwargs
        ...
        >>> thread = api.list_waf_tags(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_waf_tags_endpoint.call_with_http_info(**kwargs)
