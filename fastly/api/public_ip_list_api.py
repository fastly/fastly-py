...
class PublicIpListApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_fastly_ips_endpoint = _Endpoint(
            settings={
                'response_type': (PublicIpList,),
                'auth': [
                    'token'
                ],
    ...
    def list_fastly_ips(
        ...
        **kwargs
        ...
        """List Fastly's public IPs  # noqa: E501

        List the public IP addresses for the Fastly network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_fastly_ips(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_fastly_ips_endpoint.call_with_http_info(**kwargs)
