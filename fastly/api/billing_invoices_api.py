...
class BillingInvoicesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_invoice_by_invoice_id_endpoint = _Endpoint(
            settings={
                'response_type': (EomInvoiceResponse,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/billing/v3/invoices/{invoice_id}',
                'operation_id': 'get_invoice_by_invoice_id',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.get_month_to_date_invoice_endpoint = _Endpoint(
            settings={
                'response_type': (MtdInvoiceResponse,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/billing/v3/invoices/month-to-date',
                'operation_id': 'get_month_to_date_invoice',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://api.fastly.com",
        ...
        self.list_invoices_endpoint = _Endpoint(
            settings={
                'response_type': (ListEomInvoicesResponse,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/billing/v3/invoices',
            ...
            root_map={
                ...
                'location_map': {
                    'billing_start_date': 'query',
                    'billing_end_date': 'query',
                    'limit': 'query',
                    'cursor': 'query',
                },
                'path_params_allow_reserved_map': {
    ...
    def get_invoice_by_invoice_id(
        ...
        **kwargs
        ...
        """Get invoice by ID.  # noqa: E501

        Returns invoice associated with the invoice id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_invoice_by_invoice_id(invoice_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['invoice_id'] = \
            invoice_id
        return self.get_invoice_by_invoice_id_endpoint.call_with_http_info(**kwargs)

    def get_month_to_date_invoice(
        self,
        **kwargs
    ):
        """Get month-to-date invoice.  # noqa: E501

        Returns month-to-date invoice for the current month.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_month_to_date_invoice(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_month_to_date_invoice_endpoint.call_with_http_info(**kwargs)

    def list_invoices(
        self,
        **kwargs
    ):
        """List of invoices.  # noqa: E501

        Returns the list of invoices, sorted by billing start date (newest to oldest).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
