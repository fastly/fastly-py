...
class OriginInspectorHistoricalApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_origin_inspector_historical_endpoint = _Endpoint(
            settings={
                'response_type': (HistoricalOriginsResponse,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/metrics/origins/services/{service_id}',
                'operation_id': 'get_origin_inspector_historical',
                'http_method': 'GET',
                'servers': [
                    {
    ...
    def get_origin_inspector_historical(
        self,
        service_id,
        **kwargs
    ):
        """Get historical origin data for a service  # noqa: E501

        Fetches historical origin metrics for a given Fastly service, optionally filtering and grouping the results by origin host, region, or POP.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_origin_inspector_historical(service_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['service_id'] = \
            service_id
        return self.get_origin_inspector_historical_endpoint.call_with_http_info(**kwargs)
