...
class LoggingGcsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_log_gcs_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingGcsResponse,),
                'auth': [
                    'token'
                ],
        ...
        self.delete_log_gcs_endpoint = _Endpoint(
            settings={
        ...
        self.get_log_gcs_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingGcsResponse,),
                'auth': [
                    'token'
        ...
        self.list_log_gcs_endpoint = _Endpoint(
            settings={
                'response_type': ([LoggingGcsResponse],),
                'auth': [
                    'token'
        ...
        self.update_log_gcs_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingGcsResponse,),
                'auth': [
                    'token'
    ...
    def create_log_gcs(
        ...
        **kwargs
        ...
        """Create a GCS log endpoint  # noqa: E501

        Create GCS logging for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_log_gcs(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.create_log_gcs_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_log_gcs(
        ...
        **kwargs
        ...
        """Delete a GCS log endpoint  # noqa: E501

        Delete the GCS Logging for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_log_gcs(service_id, version_id, logging_gcs_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        kwargs['logging_gcs_name'] = \
            logging_gcs_name
        return self.delete_log_gcs_endpoint.call_with_http_info(**kwargs)
    ...
    def get_log_gcs(
        ...
        **kwargs
        ...
        """Get a GCS log endpoint  # noqa: E501

        Get the GCS Logging for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_log_gcs(service_id, version_id, logging_gcs_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['logging_gcs_name'] = \
            logging_gcs_name
        return self.get_log_gcs_endpoint.call_with_http_info(**kwargs)
    ...
    def list_log_gcs(
        ...
        **kwargs
        ...
        """List GCS log endpoints  # noqa: E501

        List all of the GCS log endpoints for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_log_gcs(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.list_log_gcs_endpoint.call_with_http_info(**kwargs)
    ...
    def update_log_gcs(
        ...
        **kwargs
        ...
        """Update a GCS log endpoint  # noqa: E501

        Update the GCS for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_log_gcs(service_id, version_id, logging_gcs_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['logging_gcs_name'] = \
            logging_gcs_name
        return self.update_log_gcs_endpoint.call_with_http_info(**kwargs)
