...
class LoggingDigitaloceanApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_log_digocean_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingDigitaloceanResponse,),
                'auth': [
                    'token'
                ],
        ...
        self.delete_log_digocean_endpoint = _Endpoint(
            settings={
        ...
        self.get_log_digocean_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingDigitaloceanResponse,),
                'auth': [
                    'token'
        ...
        self.list_log_digocean_endpoint = _Endpoint(
            settings={
                'response_type': ([LoggingDigitaloceanResponse],),
                'auth': [
                    'token'
        ...
        self.update_log_digocean_endpoint = _Endpoint(
            settings={
                'response_type': (LoggingDigitaloceanResponse,),
                'auth': [
                    'token'
    ...
    def create_log_digocean(
        self,
        service_id,
        version_id,
        **kwargs
    ):
        """Create a DigitalOcean Spaces log endpoint  # noqa: E501

        Create a DigitalOcean Space for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_log_digocean(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.create_log_digocean_endpoint.call_with_http_info(**kwargs)

    def delete_log_digocean(
        self,
        service_id,
        version_id,
        logging_digitalocean_name,
        **kwargs
        ...
        """Delete a DigitalOcean Spaces log endpoint  # noqa: E501

        Delete the DigitalOcean Space for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_log_digocean(service_id, version_id, logging_digitalocean_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        kwargs['logging_digitalocean_name'] = \
            logging_digitalocean_name
        return self.delete_log_digocean_endpoint.call_with_http_info(**kwargs)

    def get_log_digocean(
        self,
        service_id,
        version_id,
        logging_digitalocean_name,
        **kwargs
        ...
        """Get a DigitalOcean Spaces log endpoint  # noqa: E501

        Get the DigitalOcean Space for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_log_digocean(service_id, version_id, logging_digitalocean_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['logging_digitalocean_name'] = \
            logging_digitalocean_name
        return self.get_log_digocean_endpoint.call_with_http_info(**kwargs)

    def list_log_digocean(
        self,
        service_id,
        version_id,
        **kwargs
    ):
        """List DigitalOcean Spaces log endpoints  # noqa: E501

        List all of the DigitalOcean Spaces for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_log_digocean(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.list_log_digocean_endpoint.call_with_http_info(**kwargs)

    def update_log_digocean(
        self,
        service_id,
        version_id,
        logging_digitalocean_name,
        **kwargs
        ...
        """Update a DigitalOcean Spaces log endpoint  # noqa: E501

        Update the DigitalOcean Space for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_log_digocean(service_id, version_id, logging_digitalocean_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['logging_digitalocean_name'] = \
            logging_digitalocean_name
        return self.update_log_digocean_endpoint.call_with_http_info(**kwargs)
