...
class SettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_settings_endpoint = _Endpoint(
            settings={
        ...
        self.update_service_settings_endpoint = _Endpoint(
            settings={
                'response_type': (SettingsResponse,),
                'auth': [
                    'token'
    ...
    def get_service_settings(
        ...
        **kwargs
        ...
        """Get service settings  # noqa: E501

        Get the settings for a particular service and version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_service_settings(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.get_service_settings_endpoint.call_with_http_info(**kwargs)
    ...
    def update_service_settings(
        ...
        **kwargs
        ...
        """Update service settings  # noqa: E501

        Update the settings for a particular service and version. NOTE: If you override TTLs with custom VCL, any general.default_ttl value will not be honored and the expected behavior may change.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_service_settings(service_id, version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_id'] = \
            version_id
        return self.update_service_settings_endpoint.call_with_http_info(**kwargs)
