...
class DictionaryInfoApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_dictionary_info_endpoint = _Endpoint(
            settings={
                'response_type': (DictionaryInfoResponse,),
                'auth': [
                    'token'
                ],
    ...
    def get_dictionary_info(
        ...
        **kwargs
        ...
        >>> thread = api.get_dictionary_info(service_id, version_id, dictionary_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['dictionary_id'] = \
            dictionary_id
        return self.get_dictionary_info_endpoint.call_with_http_info(**kwargs)
