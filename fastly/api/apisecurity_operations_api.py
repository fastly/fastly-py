...
class ApisecurityOperationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_security_bulk_add_tags_to_operations_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2071,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/api-security/v1/services/{service_id}/operations-bulk-tags',
                'operation_id': 'api_security_bulk_add_tags_to_operations',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.api_security_bulk_create_operations_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse207,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/api-security/v1/services/{service_id}/operations-bulk',
                'operation_id': 'api_security_bulk_create_operations',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://api.fastly.com",
        ...
        self.api_security_bulk_delete_operations_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2071,),
                'auth': [
                    'token'
                ...
                'endpoint_path': '/api-security/v1/services/{service_id}/operations-bulk',
                'operation_id': 'api_security_bulk_delete_operations',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://api.fastly.com",
    ...
    def api_security_bulk_add_tags_to_operations(
        self,
        service_id,
        **kwargs
    ):
        """Bulk add tags to operations  # noqa: E501

        Add tags to multiple operations in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_security_bulk_add_tags_to_operations(service_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['service_id'] = \
            service_id
        return self.api_security_bulk_add_tags_to_operations_endpoint.call_with_http_info(**kwargs)

    def api_security_bulk_create_operations(
        self,
        service_id,
        **kwargs
    ):
        """Bulk create operations  # noqa: E501

        Create multiple operations associated with a specific service in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_security_bulk_create_operations(service_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['service_id'] = \
            service_id
        return self.api_security_bulk_create_operations_endpoint.call_with_http_info(**kwargs)

    def api_security_bulk_delete_operations(
        self,
        service_id,
        **kwargs
    ):
        """Bulk delete operations  # noqa: E501

        Delete multiple operations in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_security_bulk_delete_operations(service_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['service_id'] = \
            service_id
        return self.api_security_bulk_delete_operations_endpoint.call_with_http_info(**kwargs)
