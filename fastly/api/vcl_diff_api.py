...
class VclDiffApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.vcl_diff_service_versions_endpoint = _Endpoint(
            settings={
                'response_type': (VclDiff,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/service/{service_id}/vcl/diff/from/{from_version_id}/to/{to_version_id}',
                'operation_id': 'vcl_diff_service_versions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def vcl_diff_service_versions(
        ...
        **kwargs
        ...
        """Get a comparison of the VCL changes between two service versions  # noqa: E501

        Get a comparison of the VCL changes between two service versions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.vcl_diff_service_versions(service_id, from_version_id, to_version_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['to_version_id'] = \
            to_version_id
        return self.vcl_diff_service_versions_endpoint.call_with_http_info(**kwargs)
