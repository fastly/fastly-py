...
class LoggingEndpointErrorsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_log_endpoint_errors_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/observability/service/{service_id}/logging/errors',
                'operation_id': 'get_log_endpoint_errors',
                'http_method': 'GET',
                'servers': [
                    {
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    '_from': 'from',
                    'to': 'to',
                    'filter_endpoint': 'filter[endpoint]',
                },
                'location_map': {
                    'service_id': 'path',
                    '_from': 'query',
                    'to': 'query',
                    'filter_endpoint': 'query',
                },
    ...
    def get_log_endpoint_errors(
        ...
        **kwargs
        ...
        kwargs['service_id'] = \
            service_id
        return self.get_log_endpoint_errors_endpoint.call_with_http_info(**kwargs)
