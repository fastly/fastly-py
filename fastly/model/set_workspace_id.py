...
class SetWorkspaceId(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SetWorkspaceId - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            workspace_id (str): The workspace to link with the Next-Gen WAF product. Note this body is only supported and required when `product_id` is `ngwaf`. [optional]  # noqa: E501
        """
