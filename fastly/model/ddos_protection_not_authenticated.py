...
class DdosProtectionNotAuthenticated(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DdosProtectionNotAuthenticated - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (int): [optional] if omitted the server will use the default value of 401  # noqa: E501
        """
