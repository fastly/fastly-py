...
class Meta(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, limit, total, *args, **kwargs):  # noqa: E501
        """Meta - a model defined in OpenAPI

        Args:
            limit (int): The `limit` value used when making the request.
            total (int): The count of requests matching the filter.
    ...
    @convert_js_args_to_python_args
    def __init__(self, limit, total, *args, **kwargs):  # noqa: E501
        """Meta - a model defined in OpenAPI
