...
def lazy_import():
    ...
    globals()['RuleCreate'] = RuleCreate


class InitialVersionPath(ModelNormal):
    ...
    def _from_openapi_data(cls, path, *args, **kwargs):  # noqa: E501
        """InitialVersionPath - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rules ([RuleCreate]): The rules to create on this path.. [optional]  # noqa: E501
        """
