...
def lazy_import():
    ...
    globals()['OriginInspectorResponseService'] = OriginInspectorResponseService


class OriginInspectorResponseBodyEnable(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OriginInspectorResponseBodyEnable - a model defined in OpenAPI
