...
class EventAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EventAttributes - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin (bool): Indicates if event was performed by Fastly.. [optional]  # noqa: E501
            ...
            event_type (str): Type of event. Can be used with `filter[event_type]`. [optional]  # noqa: E501
            ip (str): IP addresses that the event was requested from.. [optional]  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Hash of key value pairs of additional information.. [optional]  # noqa: E501
