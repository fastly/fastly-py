...
class HeaderResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'response_condition': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            response_condition (bool, date, datetime, dict, float, int, list, str, none_type): Optional name of a response condition to apply.. [optional]  # noqa: E501
