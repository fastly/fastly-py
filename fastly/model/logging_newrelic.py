...
def lazy_import():
    ...
    globals()['LoggingNewrelicAllOf'] = LoggingNewrelicAllOf


class LoggingNewrelic(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LoggingNewrelic - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            format (bool, date, datetime, dict, float, int, list, str, none_type): A Fastly [log format string](https://docs.fastly.com/en/guides/custom-log-formats). Must produce valid JSON that New Relic Logs can ingest.. [optional]  # noqa: E501
