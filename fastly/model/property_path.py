...
class PropertyPath(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PropertyPath - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The URL path pattern, beginning with `/`. Maximum 2048 characters..  # noqa: E501

        Keyword Args:
            value (str): The URL path pattern, beginning with `/`. Maximum 2048 characters..  # noqa: E501
