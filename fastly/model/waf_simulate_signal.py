...
class WafSimulateSignal(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'detector': (str,),  # noqa: E501
            'detector_scope': (str,),  # noqa: E501
            'redaction': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'detector_scope': 'detector_scope',  # noqa: E501
        'redaction': 'redaction',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, detector, detector_scope, redaction, *args, **kwargs):  # noqa: E501
        """WafSimulateSignal - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            location (str): Where in the request the signal was detected (e.g., `QUERYSTRING`, `POSTBODY`, `HEADER`, `HEADEROUT`, `POSTARG`). Present for detection signals; absent for custom and action signals.. [optional]  # noqa: E501
            name (str): The parameter or header name that triggered detection. Present when the WAF engine identifies a specific parameter or header.. [optional]  # noqa: E501
            value (str): The matched payload value that triggered signal detection. For detection signals, contains the matched content. For `BLOCKED` signals, carries the WAF response code as a string. Absent for custom signals.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, detector, detector_scope, redaction, *args, **kwargs):  # noqa: E501
        """WafSimulateSignal - a model defined in OpenAPI
