...
class SecretStore(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SecretStore - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): A human-readable name for the store. The value must contain only letters, numbers, dashes (`-`), underscores (`_`), or periods (`.`).. [optional]  # noqa: E501
        """
