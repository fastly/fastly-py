...
def lazy_import():
    ...
    globals()['DictionaryResponseAllOf'] = DictionaryResponseAllOf
    globals()['ServiceIdAndVersion'] = ServiceIdAndVersion
    globals()['Timestamps'] = Timestamps


class DictionaryResponse(ModelComposed):
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'write_only': 'write_only',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DictionaryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Name for the Dictionary (must start with an alphabetic character and can contain only alphanumeric characters, underscores, and whitespace).. [optional]  # noqa: E501
            write_only (bool): Determines if items in the dictionary are readable or not.. [optional] if omitted the server will use the default value of False  # noqa: E501
