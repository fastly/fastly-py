...
class AclResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AclResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Name for the ACL. Must start with an alphanumeric character and contain only alphanumeric characters, underscores, and whitespace.. [optional]  # noqa: E501
