...
def lazy_import():
    ...
    globals()['WebsocketsResponseService'] = WebsocketsResponseService


class WebsocketsResponseBodyEnable(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WebsocketsResponseBodyEnable - a model defined in OpenAPI
