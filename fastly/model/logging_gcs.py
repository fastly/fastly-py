...
def lazy_import():
    ...
    globals()['LoggingGcsAllOf'] = LoggingGcsAllOf
...
class LoggingGcs(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LoggingGcs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            user (str): Your Google Cloud Platform service account email address. The `client_email` field in your service account authentication JSON. Required.. [optional]  # noqa: E501
            secret_key (str): Your Google Cloud Platform account secret key. The `private_key` field in your service account authentication JSON. Required.. [optional]  # noqa: E501
            bucket_name (str): The name of the GCS bucket.. [optional]  # noqa: E501
            path (bool, date, datetime, dict, float, int, list, str, none_type): The path to upload logs to.. [optional]  # noqa: E501
