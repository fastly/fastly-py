...
def lazy_import():
    ...
    globals()['SnippetResponseCommonAllOf'] = SnippetResponseCommonAllOf
    globals()['Timestamps'] = Timestamps


class SnippetResponseCommon(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SnippetResponseCommon - a model defined in OpenAPI
