...
class DashboardItemPropertyTitle(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DashboardItemPropertyTitle - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): A human-readable title for the dashboard item.  # noqa: E501

        Keyword Args:
            value (str): A human-readable title for the dashboard item.  # noqa: E501
