...
def lazy_import():
    ...
    globals()['PathResponse'] = PathResponse
    globals()['RuleResponse'] = RuleResponse


class PathWithRules(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'path': (PathResponse,),  # noqa: E501
            'rules': ([RuleResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PathWithRules - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            path (PathResponse): [optional]  # noqa: E501
            rules ([RuleResponse]): [optional]  # noqa: E501
        """
