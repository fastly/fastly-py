...
class APISecurityDiscoveredOperation(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """APISecurityDiscoveredOperation - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (DiscoveredOperationGet):  # noqa: E501

        Keyword Args:
            value (DiscoveredOperationGet):  # noqa: E501
