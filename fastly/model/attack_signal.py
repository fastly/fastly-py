...
class AttackSignal(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tag_name, tag_count, total_count, *args, **kwargs):  # noqa: E501
        """AttackSignal - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tag_name, tag_count, total_count, *args, **kwargs):  # noqa: E501
        """AttackSignal - a model defined in OpenAPI
