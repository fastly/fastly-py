...
class ConditionOperator(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The comparison operator used to evaluate the condition.., must be one of ["equals", "starts_with", "ends_with", "contains", ]  # noqa: E501

        Keyword Args:
            value (str): The comparison operator used to evaluate the condition.., must be one of ["equals", "starts_with", "ends_with", "contains", ]  # noqa: E501
