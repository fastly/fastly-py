...
class PageCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, website_id, name, *args, **kwargs):  # noqa: E501
        """PageCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, website_id, name, *args, **kwargs):  # noqa: E501
        """PageCreate - a model defined in OpenAPI
