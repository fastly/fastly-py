...
class LogAggregationsResult(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LogAggregationsResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            dimensions ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
