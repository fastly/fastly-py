...
def lazy_import():
    ...
    globals()['LoggingGrafanacloudlogsAdditional'] = LoggingGrafanacloudlogsAdditional
    globals()['ServiceIdAndVersionString'] = ServiceIdAndVersionString
    globals()['Timestamps'] = Timestamps


class LoggingGrafanacloudlogsResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LoggingGrafanacloudlogsResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index (str): The Stream Labels, a JSON string used to identify the stream.. [optional]  # noqa: E501
