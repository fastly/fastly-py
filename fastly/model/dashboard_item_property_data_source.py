...
def lazy_import():
    ...
    globals()['DashboardItemPropertyDataSourcePropertyConfig'] = DashboardItemPropertyDataSourcePropertyConfig


class DashboardItemPropertyDataSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'config': (DashboardItemPropertyDataSourcePropertyConfig,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, config, *args, **kwargs):  # noqa: E501
        """DashboardItemPropertyDataSource - a model defined in OpenAPI
