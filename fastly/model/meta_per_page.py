...
class MetaPerPage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MetaPerPage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): Number of records per page.. if omitted defaults to 20  # noqa: E501

        Keyword Args:
            value (int): Number of records per page.. if omitted defaults to 20  # noqa: E501
