...
class DdosProtectionTrafficPercentage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DdosProtectionTrafficPercentage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (float): Rule traffic percentage for the event..  # noqa: E501

        Keyword Args:
            value (float): Rule traffic percentage for the event..  # noqa: E501
