...
def lazy_import():
    ...
    globals()['TlsConfigurationsResponseAllOf'] = TlsConfigurationsResponseAllOf


class TlsConfigurationsResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TlsConfigurationsResponse - a model defined in OpenAPI
