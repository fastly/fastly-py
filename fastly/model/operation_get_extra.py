...
class OperationGetExtra(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, updated_at, *args, **kwargs):  # noqa: E501
        """OperationGetExtra - a model defined in OpenAPI

        Args:
            id (str): The unique identifier of the operation.
            updated_at (datetime): The timestamp when the operation was last updated.
