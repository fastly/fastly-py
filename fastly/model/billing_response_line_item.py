...
class BillingResponseLineItem(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'aria_invoice_id': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aria_invoice_id (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
