...
class RequestBodyForCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fqdn, *args, **kwargs):  # noqa: E501
        """RequestBodyForCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fqdn, *args, **kwargs):  # noqa: E501
        """RequestBodyForCreate - a model defined in OpenAPI
