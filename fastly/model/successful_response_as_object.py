...
def lazy_import():
    ...
    globals()['SuccessfulResponseAsObjectAllOf'] = SuccessfulResponseAsObjectAllOf
    globals()['TimestampsNoDelete'] = TimestampsNoDelete


class SuccessfulResponseAsObject(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SuccessfulResponseAsObject - a model defined in OpenAPI
