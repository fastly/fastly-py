...
class ActionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The type of action to take when a rule matches.. if omitted defaults to "service", must be one of ["service", ]  # noqa: E501

        Keyword Args:
            value (str): The type of action to take when a rule matches.. if omitted defaults to "service", must be one of ["service", ]  # noqa: E501
