...
def lazy_import():
    ...
    from fastly.model.path_response_all_of import PathResponseAllOf
    from fastly.model.property_path import PropertyPath
    from fastly.model.timestamps_no_delete import TimestampsNoDelete
    globals()['Links'] = Links
    globals()['PathResponseAllOf'] = PathResponseAllOf
    globals()['PropertyPath'] = PropertyPath
    globals()['TimestampsNoDelete'] = TimestampsNoDelete


class PathResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PathResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): Alphanumeric string identifying the path. Stable across versions of the routing config.. [optional]  # noqa: E501
            path (PropertyPath): [optional]  # noqa: E501
