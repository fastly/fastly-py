...
class AgentKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_key, secret_key, is_primary, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """AgentKey - a model defined in OpenAPI

        Args:
            access_key (str): Agent configuration access key value.
            secret_key (str): Agent configuration secret key value.
            is_primary (bool): Whether the agent key is the primary key that should be used to configure the agent.
            created_at (datetime): Date and time the agent key was created.
            updated_at (datetime): Date and time the agent key was last updated.
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_key, secret_key, is_primary, *args, **kwargs):  # noqa: E501
        """AgentKey - a model defined in OpenAPI
