...
class PropertyConfigName(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PropertyConfigName - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The user-defined name for the routing config..  # noqa: E501

        Keyword Args:
            value (str): The user-defined name for the routing config..  # noqa: E501
