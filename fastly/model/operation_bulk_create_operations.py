...
class OperationBulkCreateOperations(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, method, domain, path, *args, **kwargs):  # noqa: E501
        """OperationBulkCreateOperations - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tag_ids ([str]): An array of tag IDs to associate with this operation.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, method, domain, path, *args, **kwargs):  # noqa: E501
        """OperationBulkCreateOperations - a model defined in OpenAPI
