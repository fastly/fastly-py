...
class LegacyWafOwasp(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LegacyWafOwasp - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            created_at (str): Date and time that the settings object was created.. [optional]  # noqa: E501
            ...
            restricted_extensions (str): A space-separated list of disallowed file extensions.. [optional] if omitted the server will use the default value of ".asa/ .asax/ .ascx/ .axd/ .backup/ .bak/ .bat/ .cdx/ .cer/ .cfg/ .cmd/ .com/ .config/ .conf/ .cs/ .csproj/ .csr/ .dat/ .db/ .dbf/ .dll/ .dos/ .htr/ .htw/ .ida/ .idc/ .idq/ .inc/ .ini/ .key/ .licx/ .lnk/ .log/ .mdb/ .old/ .pass/ .pdb/ .pol/ .printer/ .pwd/ .resources/ .resx/ .sql/ .sys/ .vb/ .vbs/ .vbproj/ .vsdisco/ .webinfo/ .xsd/ .xsx"  # noqa: E501
            restricted_headers (str): A space-separated list of disallowed header names.. [optional] if omitted the server will use the default value of "/proxy/ /lock-token/ /content-range/ /translate/ /if/"  # noqa: E501
            ...
            updated_at (str): Date and time that the settings object was last updated.. [optional]  # noqa: E501
