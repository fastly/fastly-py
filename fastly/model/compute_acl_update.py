...
def lazy_import():
    ...
    globals()['ComputeAclUpdateEntry'] = ComputeAclUpdateEntry


class ComputeAclUpdate(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ComputeAclUpdate - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ComputeAclUpdateEntry]): An example of an ACL update request..  # noqa: E501

        Keyword Args:
            value ([ComputeAclUpdateEntry]): An example of an ACL update request..  # noqa: E501
