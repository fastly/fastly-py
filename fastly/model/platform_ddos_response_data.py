...
def lazy_import():
    ...
    globals()['PlatformDdosEntry'] = PlatformDdosEntry
...
class PlatformDdosResponseData(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformDdosResponseData - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PlatformDdosEntry]): A list of timeseries..  # noqa: E501

        Keyword Args:
            value ([PlatformDdosEntry]): A list of timeseries..  # noqa: E501
