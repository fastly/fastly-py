...
class BillingEstimateResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'invoice_id': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            invoice_id (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            ...
            regions ({str: ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},)}): [optional]  # noqa: E501
