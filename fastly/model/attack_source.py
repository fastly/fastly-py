...
class AttackSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, country_code, country_name, request_count, total_count, *args, **kwargs):  # noqa: E501
        """AttackSource - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, country_code, country_name, request_count, total_count, *args, **kwargs):  # noqa: E501
        """AttackSource - a model defined in OpenAPI
