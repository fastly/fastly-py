...
class ConditionResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConditionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Name of the condition. Required.. [optional]  # noqa: E501
            priority (str): A numeric string. Priority determines execution order. Lower numbers execute first.. [optional] if omitted the server will use the default value of "100"  # noqa: E501
            statement (str): A conditional expression in VCL used to determine if the condition is met.. [optional]  # noqa: E501
            service_id (str): [optional]  # noqa: E501
            version (str): A numeric string that represents the service version.. [optional]  # noqa: E501
            type (str): Type of the condition. Required.. [optional]  # noqa: E501
