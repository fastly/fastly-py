...
> disable_product_api_discovery(service_id)
...
import time
import fastly
from fastly.api import product_api_discovery_api
...
with fastly.ApiClient(configuration) as api_client:
    ...
    api_instance = product_api_discovery_api.ProductApiDiscoveryApi(api_client)
    service_id = "SU1Z0isxPaozGVKXdv0eY" # str | Alphanumeric string identifying the service.

    # example passing only required values which don't have defaults set
    try:
        # Disable product
        api_instance.disable_product_api_discovery(service_id)
    except fastly.ApiException as e:
        print("Exception when calling ProductApiDiscoveryApi->disable_product_api_discovery: %s\n" % e)
```
...
> ApiDiscoveryResponseEnable enable_product_api_discovery(service_id)
...
with fastly.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable product
        api_response = api_instance.enable_product_api_discovery(service_id)
        pprint(api_response)
    except fastly.ApiException as e:
        print("Exception when calling ProductApiDiscoveryApi->enable_product_api_discovery: %s\n" % e)
```
...
> ApiDiscoveryResponseEnable get_product_api_discovery(service_id)
...
with fastly.ApiClient(configuration) as api_client:
    ...
    try:
        # Get product enablement status
        api_response = api_instance.get_product_api_discovery(service_id)
        pprint(api_response)
    except fastly.ApiException as e:
        print("Exception when calling ProductApiDiscoveryApi->get_product_api_discovery: %s\n" % e)
```
...
with fastly.ApiClient(configuration) as api_client:
    ...
    try:
        # Get services with product enabled
        api_response = api_instance.get_services_product_api_discovery()
        pprint(api_response)
    except fastly.ApiException as e:
        print("Exception when calling ProductApiDiscoveryApi->get_services_product_api_discovery: %s\n" % e)
```
