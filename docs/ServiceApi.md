...
with fastly.ApiClient(configuration) as api_client:
    ...
    customer_id = None # bool, date, datetime, dict, float, int, list, str, none_type |  (optional)
 ...
 **customer_id** | **bool, date, datetime, dict, float, int, list, str, none_type**|  | [optional]
